...
const addService = () => {
    router.get(route('servicepage.create'));
}

const showService = (service) => {
    router.get(route('servicepage.show', service.id));
}
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="px-4 py-3">Section Some Services</th>
                                            <th scope="col" class="px-4 py-3">Section Slogan</th>
                                            <th scope="col" class="px-4 py-3">Section All Services</th>                                            
                                    ...
                                    <tbody>
                                        <tr v-for="service in services" :key="service.id"
                                            ...
                                            <td class="px-4 py-3">{{ service.sectn_services === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ service.sectn_someserv === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ service.sectn_servslogan === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ service.sectn_allserve === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">
                                            ...
                                            <td class="px-4 py-3">
                                                <button type="button" @click="showService(service)"
