...
<template>
    ...
    <SiteLayout>
        ...
        <section class="dark:bg-gray-900 mb-0 mt-5 bg-gray-700">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-full mb-8 lg:mb-16">
                    ...
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white pt-5">Infinite
                        Digits</h2>
                    <p class="text-white sm:text-xl text-justify dark:text-gray-400">We are an engineering servicing
                        company, providing support to the
                        telecommunications industry within Nigeria, the African
                        continent and the Middle East.
                        Infinite Digits partners with renowned telecom companies and
            ...
            <!-- Mission & Vision -->
                ...
                <div class="flex justify-between">
                    <div>
                        <h2
                            class="mb-4 text-2xl text-center tracking-tight font-extrabold text-orange-500 dark:text-white">
                            Our Mission</h2>
                        <p class="text-white sm:text-xl text-center dark:text-gray-400">Build the best product that
                            creates the most value for our customers,
                            use business to inspire and implement environmentally friendly solutions.</p>
                    </div>
                    <div class="ml-5">
                        <h2
                            class="mb-4 text-2xl text-center tracking-tight font-extrabold text-orange-500 dark:text-white">
        ...
        <!-- company slogan and image sub-caption -->
                ...
                <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <!-- end name -->
                             <!-- title/position brief description -->
