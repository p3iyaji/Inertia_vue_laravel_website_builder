...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->string('sectn_someserve_bg_color', 10)->nullable();
            $table->string('sectn_someserve_dark_bg_color', 10)->nullable();
            ...
            $table->string('sectn_someserve_bg_color_tw')->nullable();
            $table->string('sectn_someserve_dark_bg_color_tw')->nullable();
            $table->string('slogan_bg_color_tw')->nullable();
            $table->string('caption_color_tw')->nullable();
            $table->string('slogan_color_tw')->nullable();
            $table->string('allserve_bg_color_tw')->nullable();
