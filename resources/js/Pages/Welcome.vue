...
import SiteLayout from '../Pages/Layouts/SiteLayout.vue'
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div
                    ...
                    <div
                        ...
                        <!-- Icon Container -->
                        <div
                            class="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 mx-auto transition-all duration-300 group-hover:bg-white group-hover:text-blue-700">
                            <!-- Icon -->
                            <svg class="w-6 h-6 text-blue-600 dark:text-blue-300 transition-all duration-300 group-hover:text-blue-700"
                        ...
                        <!-- 3 options of what we do with title and description -->
                        <h3
                    ...
                    <div
                        ...
                        <!-- Content -->
                        <h3
                            class="mb-2 text-xl font-bold text-white dark:text-white transition-all duration-300 group-hover:text-gray-800">
                            Professionally Driven</h3>
                        <p
                            class="text-white dark:text-gray-400 transition-all duration-300 group-hover:text-gray-800 pl-5 pr-5">
                            Our teams are made up
                    ...
                    <div
                        class="text-center rounded-full group bg-blue-300 dark:bg-gray-800 p-6 transition-all duration-300 hover:bg-white hover:shadow-lg hover:-translate-y-1 cursor-pointer">
                        <!-- Icon Container -->
                        <div
                            class="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 mx-auto transition-all duration-300 group-hover:bg-white group-hover:text-blue-700">
                            <!-- Icon -->
                ...
                <div
                    class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0 bg-gray-100 dark:bg-gray-800 px-4 py-4 rounded-md">
                    <div
                        class="text-center group bg-white dark:bg-gray-800 rounded-lg p-6 transition-all duration-300 hover:bg-blue-700 hover:shadow-lg hover:-translate-y-1 cursor-pointer">
                        <!-- Icon Container -->
                        <div
                            class="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 mx-auto transition-all duration-300 group-hover:bg-white group-hover:text-blue-700">
                            <!-- Icon -->
                        ...
                        <!-- Content -->
                        <h3
                            class="mb-2 text-xl font-bold text-gray-900 dark:text-white transition-all duration-300 group-hover:text-white">
                            Drive Test</h3>
                        <p class="text-gray-600 dark:text-gray-400 transition-all duration-300 group-hover:text-white">
                            Focus on how you can help and benefit your user. Use simple words so that you don't confuse
                            people.</p>
                    </div>
                    <div
                        class="text-center group bg-white dark:bg-gray-800 rounded-lg p-6 transition-all duration-300 hover:bg-blue-700 hover:shadow-lg hover:-translate-y-1 cursor-pointer">
                        <div
                            class="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 mx-auto">
                        ...
                        <h3
                            class="mb-2 text-xl font-bold text-gray-900 dark:text-white transition-all duration-300 group-hover:text-white">
                            Microwave Installation & Configuration</h3>
                        <p class="text-gray-600 dark:text-gray-400 transition-all duration-300 group-hover:text-white">
                            Focus on how you can help and benefit your user. Use simple words so that you don't confuse
                            people.</p>
                    </div>
                    <div
                        class="text-center group bg-white dark:bg-gray-800 rounded-lg p-6 transition-all duration-300 hover:bg-blue-700 hover:shadow-lg hover:-translate-y-1 cursor-pointer">
                        <div
                            class="flex justify-center items-center mb-4 w-12 h-12 rounded-full bg-blue-100 mx-auto dark:bg-blue-900">
                            <svg class="w-6 h-6 text-blue-600 dark:text-blue-300" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z"
            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1
                        ...
                        Our Services</h1>
                    <p
                        class="max-w-2xl text-justify mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        We offer a wide range of services to help you achieve your goals.
                        We partner with renowned telecom companies and equipment manufacturers from around the world,
                        providing
                        superior project management and supply chain management expertise and offering guaranteed high
                        quality
