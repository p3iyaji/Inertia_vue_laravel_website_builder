...
const hero_images = ref([]); // For existing images when editing
...
const saveHero = () => {
    ...
    // Submit the form
    form.post(route('pagehero.store'), {
        data: formData,
        onSuccess: (page) => {
            const message = page.props.flash?.success || 'Hero added successfully';
            Swal.fire({
                toast: true,
                icon: 'success',
                position: 'top-end',
            ...
            <div class="p-4 rounded-lg dark:border-gray-700">
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new Hero</h2>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div v-if="hero_images && hero_images.length"
                                        ...
                                        <div v-for="(pimage, index) in hero_images" :key="pimage.id"
                                            class="relative mb-3">
                                            <img class="w-24 h-24 rounded-sm object-cover" :src="`/${pimage.image}`"
                                                alt="">
                                            <span
