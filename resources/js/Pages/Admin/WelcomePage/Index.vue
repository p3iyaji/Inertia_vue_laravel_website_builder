...
const addWelcome = () => {
    router.get(route('welcomepage.create'));
}

const showWelcome = (welcome) => {
    router.get(route('welcomepage.show', welcome.id));
}

const editWelcome = (welcome) => {
    router.get(route('welcomepage.edit', welcome.id));
}
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="px-4 py-3">Section What We Do</th>
                                            <th scope="col" class="px-4 py-3">Section Company name</th>
                                            <th scope="col" class="px-4 py-3">Section 3 Services</th>                                            
                                            <th scope="col" class="px-4 py-3">Section Other Services</th>
                                            <th scope="col" class="px-4 py-3">Section Services</th>
                                            <th scope="col" class="px-4 py-3">Section Clients</th>
                                    ...
                                    <tbody>
                                        <tr v-for="welcome in welcomes" :key="welcome.id"
                                            class="border-b dark:border-gray-700">
                                            <td class="px-4 py-3">{{ welcome.id }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_wwd === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_ccn === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_3_services === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_oservices === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_services === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">{{ welcome.sectn_client_logo === 1 ? 'On' : 'Off' }}</td>
                                            <td class="px-4 py-3">
                                                <button type="button" @click="editWelcome(welcome)"
                                            ...
                                            <td class="px-4 py-3">
                                                <button type="button" @click="showWelcome(welcome)"
                                            ...
                                            <td class="px-4 py-3">
                                                <button type="button" @click="deleteWelcome(welcome)"
                                                    class="block py-2 px-4 font-semibold hover:rounded-md text-red-600 hover:bg-red-100 dark:hover:bg-red-600 dark:hover:text-white">
                                                    Delete</button>
                                            </td>
