...
const form = useForm({
    src: '',
    main_section: '',
    office_block_bg_color: '#ffffff',
    office_title: '',
    office_title_color: '#000000',
    address: '',
...
const saveContact = () => {
    ...
    const method = 'post';
    const routeName = 'contactpage.store';
                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-4xl lg:py-16">
                        ...
                        <div class="flex justify-end mt-4">
                            <button @click="saveContact" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Save Contact
                            </button>
                        </div>
                    </div>
